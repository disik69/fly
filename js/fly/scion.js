...
function transformTransitionNode (transitionNode, parentState) {
    ...
    var __dataJSON = pm.platform.dom.getAttribute(transitionNode, "data")
    var __data = __dataJSON ? $.parseJSON(__dataJSON) : null
...
function transformStateNode(node, ancestors) {
    ...
    var __dataJSON = pm.platform.dom.getAttribute(node, "data")

    state.__data = __dataJSON ? $.parseJSON(__dataJSON) : null
